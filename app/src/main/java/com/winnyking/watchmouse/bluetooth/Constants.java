...
class Constants {
    ...
    private static final String SDP_NAME = "WatchMouse Input";
    private static final String SDP_DESCRIPTION = "WatchMouse HID Device";
    private static final String SDP_PROVIDER = "WatchMouse";
